 ...
 */
namespace DataLoader\Symfony\Component\Yaml;

use DataLoader\Symfony\Component\Yaml\Exception\DumpException;
use DataLoader\Symfony\Component\Yaml\Exception\ParseException;
use DataLoader\Symfony\Component\Yaml\Tag\TaggedValue;
/**
...
class Inline
{
    ...
    public static function dump($value, int $flags = 0) : string
    {
        switch (\true) {
            ...
            case $value instanceof \DataLoader\UnitEnum:
